...
import trendmicro.com.tangoindoornavigation.util.AdfData;
import  trendmicro.com.tangoindoornavigation.adapter.AdfUuidArrayAdapter;
...
public class AdfUuidListViewActivity extends Activity implements SetAdfNameDialog.CallbackListener {
    ...
    private static final String TAG = AdfUuidListViewActivity.class.getSimpleName();
     ...
     */
    @Override
    public void onAdfNameOk(final String name, final String uuid, final int floor) {
        if (!mIsTangoReady) {
            Toast.makeText(this, R.string.tango_not_ready, Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        new AsyncTask<Object, Void, Object>() {
            ...
            protected Void doInBackground(Object... params) {
                ...
                ADFInfo adfInfo = adfDao.queryADFByUUID(uuid);
                if (adfInfo != null) {
                    adfInfo.setADFName(name);
                    adfInfo.setFloor(floor);
                    adfDao.updateADFByItem(adfInfo);
                }
                return null;
            }
    ...
    public void deleteAdfFromTangoSpace(String uuid) {
        ...
        try {
            ...
            pointDao.removeAllPointsByUUID(uuid);
            ADFDao adfDao = new ADFDao(getApplicationContext());
            adfDao.removeADFByUUID(uuid);
        } catch (TangoErrorException e) {
    ...
    private void updateAppSpaceAdfList() {
        ...
        //Log.i(TAG, "mAppSpaceAdfFolder = " + mAppSpaceAdfFolder);
